...
<head>
    ...
    <link href="assets/plugins/tab/css/style.css" rel="stylesheet" />
    <link href="assets/plugins/tab/css/tabstyle.css" rel="stylesheet" />
...
<body class="compact-menu">
    ...
    <script src="assets/plugins/tab/tab.js"></script>
    <script>
        $(".menu").tab();
