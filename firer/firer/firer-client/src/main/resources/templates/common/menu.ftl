<div class="page-sidebar sidebar">
    <div class="page-sidebar-inner slimscroll">
        <ul class="menu accordion-menu">
            <li class="active"><a href="${ctx}/module/list" class="menu waves-effect waves-button waves-classic"><span class="menu-icon glyphicon glyphicon-cloud"></span><p>模块中心</p><span class="active-page"></span></a></li>
            <li ><a href="${ctx}/module/myModule" class="menu waves-effect waves-button waves-classic"><span class="menu-icon glyphicon glyphicon-cloud-upload"></span><p>模块管理</p><span class="active-page"></span></a></li>
            <li ><a href="${ctx}/job/list" class="menu waves-effect waves-button waves-classic"><span class="menu-icon glyphicon glyphicon-list"></span><p>任务管理</p><span class="active-page"></span></a></li>
            <li><a href="index.html" class="waves-effect waves-button waves-classic"><span class="menu-icon icon-home"></span><p>Dashboard</p><span class="active-page"></span></a></li>
