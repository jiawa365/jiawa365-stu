        ...
        <div class="checkout">
            <a class="checkout__button" href="#">
                        <span class="checkout__text">
                            <svg class="checkout__icon" width="80px" height="80px" viewBox="0 0 35 35">
            ...
            <div class="checkout__order">
                <div class="checkout__order-inner">
                    ...
                    <a href="javascript:void(0);" class="btn btn-info">Buy</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <#list modules as module>
                        <li>
                            <span class="cd-sale bg-danger">New</span>
                            <a href="#">
                            ...
                            </a><ol class="cd-dots"><li class="selected"><a href="#0">1</a></li><li><a href="#0">2</a></li><li><a href="#0">3</a></li></ol>
                            <div class="cd-item-info">
                                <b><a href="#0">${module.moduleName}</a></b>
                                <em class="cd-price">$26</em>
                            </div>
                            <div class="cd-item-details">
                                <a href="javascript:void(0)" class="pull-left add-to-cart" onclick="window.download('${module.moduleId}')"><i class="fa fa-shopping-cart"></i>下载</a>
...
<script >
    ...
    window.download=function(moduleId){
    	//发起异步请求
    	$.post('${ctx}/module/download',{moduleId:moduleId},function(result){
