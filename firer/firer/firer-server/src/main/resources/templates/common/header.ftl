<div class="navbar">
    <div class="navbar-inner">
        ...
        <div class="logo-box">
            <a href="index.html" class="logo-text"><span>Firer</span></a>
        </div><!-- Logo Box -->
                ...
                <ul class="nav navbar-nav navbar-right">
                        ...
                        <ul class="dropdown-menu title-caret dropdown-lg" role="menu">
                            ...
                            <li class="dropdown-menu-list slimscroll messages">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#">
                                            <div class="msg-img"><div class="online on"></div><img class="img-circle" src="${staticUrl}/assets/images/avatar2.png" alt=""></div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="msg-img"><div class="online off"></div><img class="img-circle" src="${staticUrl}/assets/images/avatar4.png" alt=""></div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="msg-img"><div class="online off"></div><img class="img-circle" src="${staticUrl}/assets/images/avatar3.png" alt=""></div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="msg-img"><div class="online on"></div><img class="img-circle" src="${staticUrl}/assets/images/avatar5.png" alt=""></div>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img class="img-circle avatar" src="${staticUrl}/assets/images/avatar1.png" width="40" height="40" alt="">
                        </a>
