<div class="page-sidebar sidebar">
    <div class="page-sidebar-inner slimscroll">
        <ul class="menu accordion-menu">
            ...
            <li ><a href="${ctx}/module/upload" class="menu waves-effect waves-button waves-classic"><span class="menu-icon glyphicon glyphicon-cloud-upload"></span><p>上传模块</p><span class="active-page"></span></a></li>
